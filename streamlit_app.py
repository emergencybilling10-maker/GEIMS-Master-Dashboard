...
# --- 0. LIVE WALLPAPER SETUP ---
# REPLACE THIS URL with your direct MP4 or GIF link
VIDEO_URL = "https://assets.mixkit.co/videos/preview/mixkit-abstract-technology-connection-background-blue-2415-large.mp4"
...
st.markdown(f"""
    ...
    #myVideo {{
        ...
        min-height: 100%;
        z-index: -1;
        filter: brightness(0.6); /* Adjust this to make text more readable */
    }}
    /* Added a glass-morphism effect to containers for better visibility */
    .stApp {{
