...
<style>
    ...
    div.stButton > button {
        ...
        border-radius: 12px;
        font-weight: bold;
        /* Bottom shadow creates the 3D 'thickness' */
    ...
    /* The '3D Click' Popup Effect */
    div.stButton > button:active {
        background-color: #e0e4e8;
        /* Collapse shadow and move button down to simulate a physical press */
        box-shadow: 0 0px #666;
        transform: translateY(4px);
    }

    /* 3D Glass Cards for Metrics and Bed Status */
