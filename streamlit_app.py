...
with c_col1:
    st.download_button("💳 1 - SELF PAY", "BED TRANSFER REQUEST & INFORMED CONSENT FORMPATIENT DETAILS Name: ___________________________ UHID/IP No: __________________Current Ward/Bed: _________________ Requested Ward: _________________1. TARIFF ACKNOWLEDGMENTI, the undersigned, request a transfer to the bed category selected below and acknowledge the associated daily charges as briefed by the staff:SelectRoom TypeRoom RentNursingDiet & DieticianRMO/Intensivist[  ]Suite₹ 33,000₹ 2,800₹ 1,200₹ 3,000[  ]Classic Deluxe₹ 10,000₹ 600₹ 600₹ 800[  ]Single Room₹ 7,500₹ 600₹ 600₹ 800[  ]Double Room₹ 4,500₹ 600₹ 600₹ 800[  ]Economy Room₹ 2,500₹ 500₹ 500₹ 700[  ]ICU / MICU / SICU₹ 7,500NANA₹ 800[  ]HDU₹ 6,500NA₹ 600NA[  ]NICU / PICU₹ 5,600NANANA2. CORE TERMS & CONDITIONS24-Hour Billing Cycle: The hospital billing cycle is strictly from 11:00 AM to 11:00 AM. Any stay exceeding 8 hours within a single cycle will be considered and billed as a full day.Single Bed Policy: I understand that I must vacate the previous bed immediately upon shifting to the new location. A patient cannot avail or occupy two beds at the same time. If the previous bed is not vacated to allow for other admissions, I agree to be billed for both beds at the full daily rate.Availability: I acknowledge that this transfer is strictly subject to the availability of the requested bed category and medical priority.3. DECLARATION OF AWARENESSI hereby confirm that all the above-mentioned charges and policies have been clearly explained to me by the hospital staff, and I am fully aware of them. I have read this form (or had it explained to me in a language I understand) and I am signing it voluntarily. I acknowledge that no information regarding these tariffs or rules has been withheld from me, and I cannot claim ignorance of these terms at the time of final billing.4. AUTHORIZATION & SIGNATURESignature of Patient/Attendant: ____________________ Date: _______________Name of Signatory: _______________________________ Time: _______________Relationship to Patient: ___________________________ Contact: ______________", file_name="Consent_SelfPay.txt")
with c_col2:
