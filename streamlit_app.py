...
# --- 3. LIVE DATA FETCH (WITH ERROR HANDLING) ---
if db:
    # Use cached or efficient streams to prevent 429 errors
    ...
    # LIMIT FETCH to 50 items to prevent timeouts
    ...
    st.error("Could not connect to database. Check your textkey secrets.")
    st.stop()
